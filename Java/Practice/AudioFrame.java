...
public class AudioFrame extends JFrame implements ActionListener{
    Scanner sc;
    ...
    AudioFrame() throws UnsupportedAudioFileException, IOException, LineUnavailableException, FileNotFoundException{
